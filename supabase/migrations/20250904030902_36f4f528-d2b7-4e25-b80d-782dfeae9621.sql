-- =====================================================
-- UPDATE ROLE SYSTEM FOR FOUNDER REQUIREMENTS
-- Map roles properly: Platform Admin, Enterprise Admin, Team Leader, Responder, Observer
-- =====================================================

-- Create new improved role system with proper mapping
-- First, let's update the create_pending_user function to handle activation tokens
