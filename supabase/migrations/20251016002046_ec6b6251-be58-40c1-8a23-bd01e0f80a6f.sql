-- Fix generate_activation_token to properly store expiration timestamp
...
BEGIN
  ...
  -- Update user with new activation token and expiration using || operator for proper merge
  UPDATE public.users
