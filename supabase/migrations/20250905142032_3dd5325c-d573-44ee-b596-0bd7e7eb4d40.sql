...
INSERT INTO public.locations (
  ...
  (
    'loc11111-1111-4111-a111-111111111111'::uuid,
  ...
  (
    'loc22222-2222-4222-b222-222222222222'::uuid,
  ...
  (
    'loc33333-3333-4333-c333-333333333333'::uuid,
...
INSERT INTO public.equipment (
  ...
  (
    'eq111111-1111-4111-a111-111111111111'::uuid,
    '11a11a11-1111-4111-a111-111111111111'::uuid,
    'loc11111-1111-4111-a111-111111111111'::uuid,
    'Rescue Boat Alpha',
    'Watercraft',
  ...
  (
    'eq222222-2222-4222-b222-222222222222'::uuid,
    '22b22b22-2222-4222-b222-222222222222'::uuid,
    'loc22222-2222-4222-b222-222222222222'::uuid,
  ...
  (
    'eq333333-3333-4333-c333-333333333333'::uuid,
  ...
  (
    'eq444444-4444-4444-d444-444444444444'::uuid,
...
INSERT INTO public.audit_logs (
  ...
  (
    ...
    'CREATE',
    'organization',
    '11a11a11-1111-4111-a111-111111111111',
    null,
  ...
  (
    ...
    'UPDATE',
    'equipment',
    'eq222222-2222-4222-b222-222222222222',
  ...
  (
    ...
    'CREATE',
    'user',
    'b9999c99-9999-4999-c999-999999999999',
    null,
...
INSERT INTO public.notifications (
  ...
  (
    ...
    'equipment',
    '{"equipment_id": "eq222222-2222-4222-b222-222222222222", "assignment_type": "mission"}'::jsonb
  ),
  (
    'c1a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c6'::uuid,
    'b3c33c33-3333-4333-c333-333333333333'::uuid,
...
INSERT INTO public.incidents (
  ...
  (
    'inc11111-1111-4111-a111-111111111111'::uuid,
    '7777a777-7777-4777-a777-777777777777'::uuid,
    null,
  ...
  (
    'inc22222-2222-4222-b222-222222222222'::uuid,
    '11a11a11-1111-4111-a111-111111111111'::uuid,
    'loc11111-1111-4111-a111-111111111111'::uuid,
    'b1a11a11-1111-4111-a111-111111111111'::uuid,
