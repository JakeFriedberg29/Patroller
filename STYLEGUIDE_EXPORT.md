# Styleguide Export Guide

This guide contains everything you need to export the Patroller Console design system to a new Lovable project.

## 📋 Table of Contents
1. [Design Tokens (CSS)](#1-design-tokens)
2. [Tailwind Configuration](#2-tailwind-config)
3. [Required Dependencies](#3-dependencies)
4. [shadcn/ui Components](#4-shadcnui-components)
5. [Styleguide Component](#5-styleguide-component)
...
Add these design tokens to your `index.css` file:
...
/* Design System - All colors MUST be HSL for proper theming */
...
Replace or merge your tailwind config with this:
...
Install these npm packages (use Lovable's chat to add them):
...
Use Lovable's chat to add these shadcn/ui components:
...
**Command for Lovable chat:**
```
Add these shadcn components: button input label card badge switch checkbox radio-group select separator alert dialog dropdown-menu popover tabs tooltip textarea skeleton progress avatar accordion
```
  ...
  return (
    <div className="container mx-auto py-8 space-y-12">
      <div>
        ...
        <p className="text-muted-foreground">Complete component library and design tokens</p>
      </div>
...
In Lovable chat, paste:
```
Install these packages: lucide-react sonner
```
...
2. Replace with the CSS from section 1

### Step 5: Update tailwind.config.ts
1. Open `tailwind.config.ts`
2. Replace with the config from section 2

### Step 6: Add Styleguide page
1. Create `src/pages/Styleguide.tsx`
2. Paste the component code from section 5
...
### Step 8: View your styleguide
Navigate to `/styleguide` in your app to see the complete design system!
...
- Dark mode is included and works automatically
- All components follow accessibility best practices
- The design system is fully responsive
- Custom status colors (critical, warning, success, info) are built-in

## 🎨 Customization

To customize colors, edit the CSS variables in `index.css`. The system will automatically adjust all components.

## 💡 Usage Tips

1. **Reference the styleguide** when building new features
...
✨ Your complete design system is ready to use!